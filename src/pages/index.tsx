...
export default function HomePage() {
  return (
    <> <div className="min-h-screen bg-gradient-to-br from-blue-50 via-white to-purple-50">
      <Head>
        <title>
          GitSense.dev - AI-Optimized Code Analysis & Repository Intelligence
        </title>
        <meta
          name="description"
          content="Analyze GitHub repositories and code snippets for AI conversations. Save 80% on AI tokens with intelligent code summaries and context optimization."
        />
      </Head>
        ...
        <section className="pt-20 pb-16 px-4">
          <div className="max-w-7xl mx-auto text-center">
            ...
            <p className="text-xl text-gray-600 mb-8 max-w-3xl mx-auto">
              Save 80% on AI tokens while maintaining perfect context. Analyze
              any codebase in minutes and generate optimized summaries for
